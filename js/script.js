...
window.addEventListener("DOMContentLoaded", function () {
  ...
  // tabs start
  const tabHeaderParrent = document.querySelector(".tabheader__items");
  const tabHeaders = tabHeaderParrent.querySelectorAll(".tabheader__item");
  const tabContents = document.querySelectorAll(".tabcontent");

  // function for hiddeing all tabs and all active classes
  function hideTabContentsAndActiveClass() {
  ...
  hideTabContentsAndActiveClass();
  showTabContentsAndActiveClass()

  // event delegation
  tabHeaderParrent.addEventListener("click", (e) => {
  ...
  // timer start
   const endTime = "2025-11-31 13:59:59 "
